#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/kuhing/main/vps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/nielaa27/cinta/main/vps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/nielaa27/cinta/main/vps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/nielaa27/cinta/ip/main/vps | grep $MYIP | awk '{print $3}')
fi
...
sh="$(awk -F: '$3 >= 1000 && $1 != "nobody" {print $1}' /etc/passwd | wc -l)"
...
echo -e "${IPurple} │${NC} ${ICyan}𖡛$bd TOTAL BW  ${NC}    : ${YELLOW} [$tmon]${NC} TOTAL   ${NC}           ${IPurple}│"
echo -e "${IPurple} └──────────────────────────────────────────────────┘${NC}" 
echo""
echo -e "${IPurple}┌──────────────────────────┐${NC}"
...
echo -e  "${IPurple}└──────────────────────────┘${NC}"
echo -e "${IPurple}┌──────────────────────────┐${NC}"
echo -e "${IPurple}│${NC} $bd𖡛$bd SSH   : ${BIYellow}[$sh]${NC}${BICyan}Member ${NC}"
echo -e "${IPurple}│${NC} $bd𖡛$bd VMESS : ${NC}${BIYellow}[$vmc]$NC${BICyan} Member ${NC}"
echo -e "${IPurple}│${NC} $bd𖡛$bd VLESS : ${NC}${BIYellow}[$vlx]$NC${BICyan} Member ${NC}"
echo -e "${IPurple}│${NC} $bd𖡛$bd TROJAN : ${NC}${BIYellow}[$trx]$NC${BICyan} Member $(NC)"
echo -e  "${IPurple}└──────────────────────────┘${NC}"
echo""
echo -e "${IPurple}┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e "${IPurple}│${BICyan}[${BIWhite}03${BICyan}] VLESS   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${BIWhite}08${BICyan}]  SETTING      ${NC}" "${BICyan}      ${IPurple}│"
...
echo -e "${IPurple}│${BICyan}[${BIWhite}05${BICyan}] SSWS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${BIWhite}TELE${BICyan}] @xlordeuyy  ${BICyan}[${BIYellow}DEV${BICyan}]${NC}" "${BICyan}${NC} ${IPurple}│"
echo -e "${IPurple}└───────────────────────────────────────────────────┘${NC}"
...
echo -e " ${IPurple}┌─────────────────────────────────────┐${NC}"
echo -e " ${IPurple}│${NC}   Version        : 4.0 Lite ${NC}"
