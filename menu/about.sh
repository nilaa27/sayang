...
echo ""  | tee -a log-install.txt
echo "   $NC    ${sc} [INFORMASI SSH SERVICE PORT] ${NC}" | tee -a log-install.txt
echo "   - ——————————————————————————————————————"
...
echo ""  | tee -a log-install.txt
echo "   $NC    ${sc} [INFORMASI Grpc, Bdvp, Ngnx] ${NC}" | tee -a log-install.txt
echo "   - ——————————————————————————————————————"
echo "   - Badvpn                  : 7200"  | tee -a log-install.txt
echo "   - Nginx                   : 81"  | tee -a log-install.txt
echo "   - Grpc                    : 443"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "   $NC    ${sc} [INFORMASI XRAY] ${NC}"  | tee -a log-install.txt
echo "   - ——————————————————————————————————————"
...
echo "   - ——————————————————————————————————————"
echo "   -$NC    ${sc} [ALL SERVICE SC] ${NC}"  | tee -a log-install.txt
echo""
