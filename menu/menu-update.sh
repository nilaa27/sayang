...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/nilaa27/cinta/ip/main/vps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/nilaa27/cinta/ip/main/vps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/nilaa27/cinta/ip/main/vps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
wget -O menu-ssws " https://raw.githubusercontent.com/nilaa27/sayang/main/menu/menu-ssws.sh"
...
wget -O menu-backup " https://raw.githubusercontent.com/nilaa27/sayang/main/menu/menu-backup.sh"
...
wget -O cf " https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/cf.sh"
wget -O menu-bckp "https://raw.githubusercontent.com/nilaa27/sayang/main/menu/menu-bckp.sh"
wget -O add-ssws " https://raw.githubusercontent.com/nilaa27/sayang/main/xray/add-ssws.sh"
wget -O add-v2ray " https://raw.githubusercontent.com/nilaa27/sayang/main/xray/add-v2ray.sh"
wget -O wireguard " https://raw.githubusercontent.com/nilaa27/sayang/main/wireguard/add-wireguard.sh"
wget -O add-ns " https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/add-ns.sh"
wget -O issue " https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/issue.net"
