...
curl -sS https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/nginx.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/newudpgw"
...
#OpenvPN
wget https://raw.githubusercontent.com/nilaa27/sayang/main/OPENvPN/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# // install lolcat
wget https://raw.githubusercontent.com/nilaa27/tarong/main/tarong/SSH/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
# install fail2ban
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/nilaa27/sayang/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
