...
# set locale
sed -i 's/AcceptEnv/#AcceptEnv/g' /etc/ssh/file_boss
...
# setting port ssh
cd
sed -i 's/PasswordAuthentication no/PasswordAuthentication yes/g' /etc/ssh/file_boss
sed -i '/Port 22/a Port 500' /etc/ssh/file_boss
sed -i '/Port 22/a Port 40000' /etc/ssh/file_boss
sed -i '/Port 22/a Port 51443' /etc/ssh/file_boss
sed -i '/Port 22/a Port 58080' /etc/ssh/file_boss
sed -i '/Port 22/a Port 200' /etc/ssh/file_boss
sed -i '/Port 22/a Port 22' /etc/ssh/file_boss
...
echo "Banner /etc/issue.net" >> /etc/ssh/file_boss
