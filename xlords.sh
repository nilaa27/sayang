...
sleep 2
clear
wget https://raw.githubusercontent.com/nilaa27/sayang/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
#install Backup
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By NIELA PROJECT ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
