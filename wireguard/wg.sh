...
echo -e "${NC}${LIGHT}WhatsApp : 0881036683241"
echo -e "${NC}${LIGHT}Telegram : https://t.me/Xlordeuyy"
exit 0
fi
# ==================================================
# Link Hosting Kalian
xlord="raw.githubusercontent.com/Tarap-Kuhing/sc/main/wireguard"
...
echo -e "${Info} Wireguard Script By xxx"
